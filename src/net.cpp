...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Woerglcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"node.rheinlaender.no-ip.org", "seed.rheinlaender.no-ip.org"},
    {"abacus.rheinlaender.no-ip.org", "fledge.rheinlaender.no-ip.org"},
    {"mainnet.rheinlaender.no-ip.org.pw", "seed.mainnet.rheinlaender.no-ip.org.pw"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"testnet.woerglcoin.pw", "seed.testnet.woerglcoin.pw"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Woerglcoin is probably already running."), addrBind.ToString().c_str());
        else
