...
const QString BITCOIN_IPC_PREFIX("woerglcoin:");
...
PaymentServer::PaymentServer(QApplication* parent) : QObject(parent), saveURIs(true)
{
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start woerglcoin: click-to-pay handler");
    else
...
{
    // clicking on woerglcoin: URLs creates FileOpen events on the Mac:
